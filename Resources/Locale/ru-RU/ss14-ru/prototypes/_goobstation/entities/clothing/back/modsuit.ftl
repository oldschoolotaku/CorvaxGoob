...
ent-ClothingModsuitChiefEngineer = контроллер скафандра MOD «Архонт»
    .desc = Контроллер скафандра, сделанный на основе продвинутого скафандра Nakamura Engineering. Создан для взаимодействия с суперматерией и самыми высочайшими температурами.
ent-ClothingModsuitChiefEngineerPowerCell = { ent-ClothingModsuitChiefEngineer }
    .suffix = батарея высокой ёмкости
    .desc = { ent-ClothingModsuitChiefEngineer.desc }
