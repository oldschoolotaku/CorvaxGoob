...
ent-ClothingModsuitGauntletsChiefEngineer = перчатки скафандра MOD «Архонт»
    .desc = Сделаны специально, чтобы можно было брать осколки суперматерии без использования любых других инструментов.
