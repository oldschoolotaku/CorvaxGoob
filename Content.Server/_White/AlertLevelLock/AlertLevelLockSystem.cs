...
using Content.Shared._White.AlertLevelLock.Components;
using Content.Shared.Emag.Systems;
using Content.Shared.Examine;
using Robust.Shared.Prototypes;

namespace Content.Server._White.AlertLevelLock;
...
public sealed class StationAlertLevelLockSystem : EntitySystem
{
    ...
    private void OnInit(EntityUid uid, StationAlertLevelLockComponent component, MapInitEvent args)
    {
    ...
    {
        if (newAlertLevel is "violet" or "yellow")
        {
            if (component.PreviousAlertLevel is "blue" or "red")
            {
